...
import AddressGroups from './index/AddressGroups.vue';
...
const { loading, settings, openSettings, indexTab, globalTabplacement, useSimpleIndex, showAboutLinks } = useGlobalState()
...
watch([indexTab, showAboutLinks], () => {
  if (indexTab.value === 'about' && !showAboutLinks.value) {
    ...
    <div v-else>
      ...
      <n-tabs v-if="settings.address" type="card" v-model:value="indexTab" :placement="globalTabplacement">
        ...
        <n-tab-pane name="apiTokens" :tab="t('apiTokens')">
          <ApiTokens api-prefix="/api/api_tokens" />
        </n-tab-pane>
        ...
        <n-tab-pane name="addressGroups" :tab="t('addressGroups')">
          <AddressGroups />
        </n-tab-pane>
        ...
        <n-tab-pane v-if="openSettings.enableIndexAbout && showAboutLinks" name="about" :tab="t('about')">
          <About />
        </n-tab-pane>
      </n-tabs>
    </div>
