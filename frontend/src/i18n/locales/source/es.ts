export const esMessages = {
  ...
  "views.Admin.aiAdvisor": "Asesor de IA",
  "views.Index.aiAdvisor": "Asesor de IA",
  ...
  "views.Header.title": "Plataforma de gestión de correo empresarial",
  ...
  "views.Footer.copyright": "© 2026-2030 Enterprise Mail. Todos los derechos reservados.",
  ...
  "components.MailContentRenderer.remoteImagesBlocked": "{count} recursos remotos bloqueados para proteger tu privacidad",
  "views.Index.addressGroups": "Grupos",
  "views.Admin.address_groups": "Grupos",
  "views.Admin.subAdmins": "Subadministradores",
  "views.Admin.domainCreateCosts": "Costo de creación por dominio",
  "views.Admin.roleMain": "Administrador principal",
  "views.Admin.roleSub": "Subadministrador",
  "views.Admin.sessionExpiredTip": "Sesión de administrador expirada. Ingrese nombre de usuario y contraseña nuevamente, o regrese al inicio de sesión.",
  "views.Admin.backToLogin": "Volver al inicio de sesión",
  "views.Admin.username": "Usuario",
  "views.Admin.password": "Contraseña",
  "views.Admin.loginFailed": "Error de inicio de sesión",
  "views.user.AddressManagement.itemCount": "Total",
  "components.AiAdvisor.advisor": "Asistente de IA",
  "components.AiAdvisor.aiMissing": "El Worker actual no está vinculado a Cloudflare Workers AI; el chat no está disponible temporalmente.",
  "components.AiAdvisor.authHintAdmin": "Primero seleccione un subadministrador, despliéguelo para marcar buzones específicos o use grupos para selección total.",
  "components.AiAdvisor.authHintUser": "Seleccione los buzones para autorizar el contexto de IA.",
  "components.AiAdvisor.authTitle": "Autorizar buzones",
  "components.AiAdvisor.authorizedCount": "{count} autorizados",
  "components.AiAdvisor.chatCleared": "Historial de chat borrado",
  "components.AiAdvisor.chatEmpty": "No hay historial de chat",
  "components.AiAdvisor.chatFailed": "Error al enviar",
  "components.AiAdvisor.chatHint": "La IA responde preguntas basadas en buzones autorizados. No comparta información confidencial.",
  "components.AiAdvisor.chatPlaceholder": "Pregunte a la IA sobre sus correos... (Enter para enviar, Shift+Enter para nueva línea)",
  "components.AiAdvisor.chatTitle": "Chat con IA",
  "components.AiAdvisor.clearAll": "Limpiar todo",
  "components.AiAdvisor.clearChat": "Limpiar chat",
  "components.AiAdvisor.contactAdmin": "Comuníquese con el administrador para habilitar los permisos de IA",
  "components.AiAdvisor.customHint": "Compatible con API estilo OpenAI y API de Claude.",
  "components.AiAdvisor.driverCf": "Cloudflare Workers AI",
  "components.AiAdvisor.driverCfDesc": "Modelos integrados gratuitos, no se requieren claves de API.",
  "components.AiAdvisor.driverCustom": "API de IA personalizada",
  "components.AiAdvisor.driverCustomDesc": "Use sus propias claves de API para OpenAI, DeepSeek, Claude, etc.",
  "components.AiAdvisor.driverHint": "Elija el controlador de modelo para las conversaciones de IA.",
  "components.AiAdvisor.driverPick": "Seleccionar controlador",
  "components.AiAdvisor.driverTitle": "Controlador de modelo",
  "components.AiAdvisor.driverUsing": "En uso",
  "components.AiAdvisor.enableCf": "Habilitar Cloudflare Workers AI",
  "components.AiAdvisor.emptyLocal": "No hay buzones disponibles",
  "components.AiAdvisor.emptyMailboxes": "No se encontraron buzones autorizados",
  "components.AiAdvisor.loadFailed": "Error al cargar",
  "components.AiAdvisor.saveAuth": "Guardar autorización",
  "components.AiAdvisor.saveFailed": "Error al guardar",
  "components.AiAdvisor.saved": "Guardado exitosamente",
  "components.AiAdvisor.searchMailbox": "Buscar buzón",
  "components.AiAdvisor.selectAll": "Seleccionar todo",
  "components.AiAdvisor.send": "Enviar",
  "components.AiAdvisor.settingsTitle": "Configuración de IA",
  "components.AiAdvisor.subAdmins": "Subadministradores",
  "components.AiAdvisor.subDefault": "Política predeterminada de subadministrador",
  "components.AiAdvisor.subInherited": "Heredado del predeterminado",
  "components.AiAdvisor.subRestore": "Restaurar a predeterminado",
  "components.AiAdvisor.users": "Usuarios de buzón",
  "components.AiAdvisor.policyHint": "Configure si los roles pueden usar controladores de IA personalizados y qué modelos están permitidos.",
  "components.AiAdvisor.policyOwnDriver": "Permitir controlador personalizado propio",
  "components.AiAdvisor.policySaved": "Política guardada",
  "components.AiAdvisor.allowedModels": "Modelos de Cloudflare permitidos (vacío para todos los gratuitos)",
  "components.AiAdvisor.savePolicy": "Guardar política",
  "components.AiAdvisor.saveDriver": "Guardar controlador",
  "components.AiAdvisor.driverSaved": "Configuración del controlador guardada",
  "components.AiAdvisor.apiFormat": "Formato de API",
  "components.AiAdvisor.baseUrl": "URL base de la API",
  "components.AiAdvisor.modelId": "ID del modelo",
  "components.AiAdvisor.apiKey": "Clave de API",
  "components.AiAdvisor.apiKeyKept": "Clave de API configurada (dejar vacío para mantener)",
  "components.AiAdvisor.test": "Probar conexión",
  "components.AiAdvisor.testHint": "Envía una solicitud mínima de ping a la API configurada para verificar.",
  "components.AiAdvisor.testStatus": "Estado {status}",
  "components.AiAdvisor.firstToken": "Primer token {ms} ms",
  "components.AiAdvisor.totalTime": "Completo {ms} ms",
  "components.AiAdvisor.modelSelect": "Seleccionar modelo",
  "components.AiAdvisor.needCustom": "Se requiere controlador personalizado",
  "components.AiAdvisor.formatOpenAi": "Compatible con OpenAI (ej. DeepSeek, OneAPI)",
  "components.AiAdvisor.formatClaude": "API de Anthropic Claude",
  "components.AiAdvisor.you": "Tú",
  "components.ApiTokens.title": "Token de API",
  "components.ApiTokens.hint": "Tokens para scripts y automatización. Encabezado: Authorization: Bearer <token>. Por defecto incluye todos los permisos de su rol.",
  "components.ApiTokens.usage": "Uso",
  "components.ApiTokens.lastUsed": "Último uso",
  "components.ApiTokens.neverUsed": "Nunca usado",
  "components.ApiTokens.name": "Nombre del token",
  "components.ApiTokens.create": "Crear token",
  "components.ApiTokens.created": "Token creado exitosamente. Cópielo y guárdelo de forma segura; no se volverá a mostrar.",
  "components.ApiTokens.copy": "Copiar",
  "components.ApiTokens.copied": "Copiado al portapapeles",
  "components.ApiTokens.revoke": "Revocar",
  "components.ApiTokens.revokeConfirm": "¿Seguro que desea revocar este token? Todas las solicitudes que lo usen fallarán de inmediato.",
  "components.ApiTokens.empty": "Aún no hay tokens",
  "components.ApiTokens.prefix": "Prefijo",
  "components.ApiTokens.createdAt": "Creado el",
  "components.ApiTokens.read": "Lectura",
  "components.ApiTokens.write": "Escritura",
  "components.ApiTokens.details": "Detalles",
  "components.ApiTokens.loadFailed": "Error al cargar tokens",
  "components.ApiTokens.saveFailed": "Error al crear token",
  "components.ApiTokens.nameRequired": "Por favor ingrese un nombre para el token",
  "components.ApiTokens.needScope": "Por favor seleccione al menos un permiso",
  "components.ApiTokens.downloadDoc": "Descargar documentación de API para IA",
  "components.ApiTokens.downloadFailed": "Error al descargar",
  "components.ApiTokens.category.address": "Cuentas de correo",
  "components.ApiTokens.category.mail": "Correos",
  "components.ApiTokens.category.send": "Enviar correo",
  "components.ApiTokens.category.sender_access": "Permisos de remitente",
  "components.ApiTokens.category.settings": "Configuración de cuenta y control",
  "components.ApiTokens.category.sub_admin": "Subadministradores y cuotas",
  "components.ApiTokens.category.ai_advisor": "Asistente de IA",
  "components.ApiTokens.category.telegram": "Bot de Telegram",
  "components.ApiTokens.category.statistics": "Estadísticas",
  "components.ApiTokens.category.maintenance": "Mantenimiento del sistema",
  "components.ApiTokens.category.appearance": "Apariencia",
  "components.ApiTokens.category.self_service": "Autoservicio de buzón",
  "components.ApiTokens.scope.address.list.read": "Leer lista de direcciones",
  "components.ApiTokens.scope.address.credential.read": "Leer credenciales de dirección",
  "components.ApiTokens.scope.address.create.write": "Crear dirección",
  "components.ApiTokens.scope.address.password.write": "Modificar contraseña",
  "components.ApiTokens.scope.address.delete.write": "Eliminar dirección",
  "components.ApiTokens.scope.address.clear_inbox.write": "Vaciar bandeja de entrada",
  "components.ApiTokens.scope.address.clear_sent.write": "Vaciar elementos enviados",
  "components.ApiTokens.scope.address.group.read": "Ver grupos",
  "components.ApiTokens.scope.address.group.write": "Administrar grupos",
  "components.ApiTokens.scope.address.note.write": "Modificar notas",
  "components.ApiTokens.scope.mail.inbox.read": "Leer bandeja de entrada",
  "components.ApiTokens.scope.mail.inbox.write": "Administrar bandeja de entrada",
  "components.ApiTokens.scope.mail.unknown.read": "Leer correos desconocidos",
  "components.ApiTokens.scope.mail.sendbox.read": "Leer correos enviados",
  "components.ApiTokens.scope.mail.sendbox.write": "Eliminar correos enviados",
  "components.ApiTokens.scope.send.mail.write": "Enviar correo",
  "components.ApiTokens.scope.send.request.write": "Solicitar cuota de envío",
  "components.ApiTokens.scope.sender_access.list.read": "Ver lista de permisos de remitente",
  "components.ApiTokens.scope.sender_access.update.write": "Actualizar saldo de remitente",
  "components.ApiTokens.scope.sender_access.delete.write": "Eliminar permiso de remitente",
  "components.ApiTokens.scope.settings.account.read": "Leer configuración de cuenta",
  "components.ApiTokens.scope.settings.account.write": "Modificar configuración de cuenta",
  "components.ApiTokens.scope.settings.ip.read": "Leer lista negra de IP",
  "components.ApiTokens.scope.settings.ip.write": "Modificar lista negra de IP",
  "components.ApiTokens.scope.settings.webhook.read": "Leer configuración de Webhook",
  "components.ApiTokens.scope.settings.webhook.write": "Modificar configuración de Webhook",
  "components.ApiTokens.scope.settings.mail_webhook.read": "Leer configuración de Webhook de correo",
  "components.ApiTokens.scope.settings.mail_webhook.write": "Modificar configuración de Webhook de correo",
  "components.ApiTokens.scope.sub_admin.list.read": "Ver lista de subadministradores",
  "components.ApiTokens.scope.sub_admin.ledger.read": "Ver registro de cuotas",
  "components.ApiTokens.scope.sub_admin.costs.read": "Ver costos por dominio",
  "components.ApiTokens.scope.sub_admin.manage.write": "Administrar subadministradores",
  "components.ApiTokens.scope.sub_admin.quota.write": "Ajustar cuotas",
  "components.ApiTokens.scope.sub_admin.costs.write": "Modificar costos por dominio",
  "components.ApiTokens.scope.ai_advisor.read": "Leer datos del asistente de IA",
  "components.ApiTokens.scope.ai_advisor.write": "Chat de IA y autorización",
  "components.ApiTokens.scope.ai_advisor.policy.read": "Leer políticas de IA",
  "components.ApiTokens.scope.ai_advisor.policy.write": "Modificar políticas de IA",
  "components.ApiTokens.scope.telegram.read": "Leer configuración de Telegram",
  "components.ApiTokens.scope.telegram.write": "Modificar configuración de Telegram",
  "components.ApiTokens.scope.statistics.read": "Ver estadísticas",
  "components.ApiTokens.scope.maintenance.read": "Leer configuración de mantenimiento",
  "components.ApiTokens.scope.maintenance.write": "Ejecutar limpieza de mantenimiento",
  "components.ApiTokens.scope.appearance.read": "Leer configuración de apariencia",
  "components.ApiTokens.scope.appearance.write": "Modificar configuración de apariencia",
  "components.ApiTokens.scope.self_service.read": "Leer propio buzón",
  "components.ApiTokens.scope.self_service.write": "Administrar propio buzón",
  "views.admin.Account.owner": "Creador",
  "views.admin.Account.ownerMain": "Admin principal",
  "views.admin.Account.ownerSub": "Subadmin",
  "views.admin.Account.expires_at": "Fecha de vencimiento",
  "views.admin.Account.multiSettings": "Configuración por lote",
  "views.admin.Account.multiSettingsTip": "Actualizar fecha de vencimiento y notas para las direcciones seleccionadas.",
  "views.admin.Account.editNote": "Editar nota",
  "views.admin.Account.note": "Nota",
  "views.admin.Account.notePlaceholder": "Ingrese una nota (visible solo para usted)",
  "views.admin.Account.saveNote": "Guardar nota",
  "views.admin.Account.allGroups": "Todos los grupos",
  "views.admin.AddressGroups.actions": "Acciones",
  "views.admin.AddressGroups.addMember": "Agregar miembros",
  "views.admin.AddressGroups.create": "Crear grupo",
  "views.admin.AddressGroups.created_at": "Creado el",
  "views.admin.AddressGroups.delete": "Eliminar",
  "views.admin.AddressGroups.deleteConfirm": "¿Eliminar grupo {name}?",
  "views.admin.AddressGroups.emptyMembers": "No hay miembros en este grupo",
  "views.admin.AddressGroups.limitsTip": "El admin principal no tiene límites. Aquí solo ajusta los límites para subadmins y usuarios.",
  "views.admin.AddressGroups.memberCount": "Cant. buzones",
  "views.admin.AddressGroups.members": "Miembros",
  "views.admin.AddressGroups.name": "Nombre del grupo",
  "views.admin.AddressGroups.namePlaceholder": "Ingrese nombre del grupo",
  "views.admin.AddressGroups.nameRequired": "El nombre del grupo es obligatorio",
  "views.admin.AddressGroups.query": "Consultar",
  "views.admin.AddressGroups.remove": "Quitar",
  "views.admin.AddressGroups.rename": "Renombrar",
  "views.admin.AddressGroups.save": "Guardar",
  "views.admin.AddressGroups.saveLimits": "Guardar límites",
  "views.admin.AddressGroups.searchAddress": "Buscar dirección",
  "views.admin.AddressGroups.subLimit": "Límite de grupos para subadmin",
  "views.admin.AddressGroups.success": "Éxito",
  "views.admin.AddressGroups.tip": "Los grupos y notas son privados para la función actual y no visibles para otros.",
  "views.admin.AddressGroups.unlimitedUsed": "Usados {used}, ilimitado",
  "views.admin.AddressGroups.usedOfMax": "Usados {used} / Máx {max}",
  "views.admin.AddressGroups.userLimit": "Límite de grupos para usuarios",
  "views.index.LocalAddress.multiDelete": "Eliminar seleccionados",
  "views.index.LocalAddress.multiDeleteTip": "¿Seguro que desea eliminar los buzones seleccionados?",
  "views.index.LocalAddress.multiSettings": "Configuración por lote",
  "views.index.LocalAddress.multiSettingsTip": "Modificar contraseña o notas para los buzones seleccionados por lote.",
  "views.index.LocalAddress.selectAll": "Seleccionar todo",
  "views.index.LocalAddress.unselectAll": "Deseleccionar todo",
  "views.index.LocalAddress.selectedItems": "Seleccionado",
  "views.index.LocalAddress.pleaseSelectAddress": "Por favor seleccione al menos un buzón",
  "views.index.LocalAddress.newPassword": "Nueva contraseña",
  "views.index.LocalAddress.newPasswordRequired": "La nueva contraseña es obligatoria",
  "views.index.LocalAddress.allGroups": "Todos los grupos",
  "views.index.LocalAddress.editNote": "Editar nota",
  "views.admin.CreateAccount.expireDays": "Días de validez",
  "views.admin.CreateAccount.expireDaysSubTip": "Para subadmins: de 1 a 90 días. Admin principal: sin límite.",
  "views.admin.CreateAccount.note": "Nota",
  "views.admin.CreateAccount.notePlaceholder": "Ingrese una nota (opcional)",
  "views.admin.CreateAccount.group": "Grupo",
  "views.admin.CreateAccount.groupAuto": "Grupo predeterminado (asignación automática)",
  "views.common.Appearance.autoLoadRemoteImages": "Cargar imágenes remotas automáticamente",
  "views.common.Appearance.hideAboutTitle": "Ocultar enlaces de 'Acerca de'",
  "views.common.Appearance.hideAboutDesc": "Controle para qué roles se ocultan los enlaces de 'Acerca de' y GitHub.",
  ...
  "views.common.Appearance.hideAboutUser": "Ocultar para usuarios de buzón",
  "views.common.Appearance.successTip": "Configuración guardada exitosamente",
  "views.common.Login.addMailbox": "Agregar buzón",
  "views.common.EnterpriseLogin.selectLanguage": "Idioma",
  "views.common.EnterpriseLogin.companyNameFallback": "Plataforma de correo empresarial",
  "views.common.EnterpriseLogin.brandTitle": "Plataforma de correo empresarial",
  "views.common.EnterpriseLogin.brandSubtitle": "Un sistema de correo seguro y autohospedado en su propio dominio. Los administradores crean buzones en segundos.",
  "views.common.EnterpriseLogin.brandPoint1": "Los administradores crean buzones en su dominio",
  "views.common.EnterpriseLogin.brandPoint2": "Cada buzón tiene su propio período de retención y control de acceso",
  "views.common.EnterpriseLogin.brandPoint3": "Se ejecuta completamente en Cloudflare Workers",
  "views.common.EnterpriseLogin.brandFoot": "© 2026-2030 Enterprise Mail. Todos los derechos reservados.",
  "views.common.EnterpriseLogin.loginTitle": "Iniciar sesión",
  "views.common.EnterpriseLogin.loginSubtitle": "Inicie sesión en su buzón o acceda a la consola de administración.",
  "views.common.EnterpriseLogin.employeeTab": "Inicio de sesión de buzón",
  "views.common.EnterpriseLogin.adminTab": "Administrador",
  "views.common.EnterpriseLogin.emailLabel": "Dirección de correo",
  "views.common.EnterpriseLogin.emailPlaceholder": "Ingrese su correo",
  "views.common.EnterpriseLogin.passwordLabel": "Contraseña",
  "views.common.EnterpriseLogin.passwordPlaceholder": "Ingrese su contraseña",
  "views.common.EnterpriseLogin.credentialLabel": "Credenciales de buzón",
  "views.common.EnterpriseLogin.credentialPlaceholder": "Pegue la credencial JWT",
  "views.common.EnterpriseLogin.usernameLabel": "Nombre de usuario",
  "views.common.EnterpriseLogin.usernamePlaceholder": "Ingrese usuario administrador",
  "views.common.EnterpriseLogin.loginEmail": "Entrar al buzón",
  "views.common.EnterpriseLogin.loginAdmin": "Abrir consola de administración",
  "views.common.EnterpriseLogin.credentialLogin": "Usar credenciales en su lugar",
  "views.common.EnterpriseLogin.passwordLogin": "Usar contraseña en su lugar",
  "views.common.EnterpriseLogin.adminHint": "Tanto el usuario como la contraseña son verificados.",
  "views.common.EnterpriseLogin.employeeHint": "Inicie sesión con el buzón y la contraseña asignados por un administrador.",
  "views.common.EnterpriseLogin.emailPasswordRequired": "Se requieren correo y contraseña",
  "views.common.EnterpriseLogin.adminRequired": "Se requieren usuario y contraseña",
  "views.common.EnterpriseLogin.credentialInput": "Por favor pegue las credenciales del buzón",
  "views.common.EnterpriseLogin.loginFailed": "Error de inicio de sesión",
  "views.admin.SubAdmins.tip": "Crear subadministradores, agregar puntos, cambiar contraseñas, habilitar/deshabilitar y eliminar.",
  "views.admin.SubAdmins.create": "Crear cuenta",
  "views.admin.SubAdmins.username": "Nombre de usuario",
  "views.admin.SubAdmins.password": "Contraseña",
  "views.admin.SubAdmins.quotaBalance": "Saldo restante",
  "views.admin.SubAdmins.initialQuota": "Cuota inicial",
  "views.admin.SubAdmins.enabled": "Habilitado",
  "views.admin.SubAdmins.created_at": "Creado el",
  "views.admin.SubAdmins.actions": "Acciones",
  "views.admin.SubAdmins.addQuota": "Agregar saldo",
  "views.admin.SubAdmins.changePassword": "Cambiar contraseña",
  "views.admin.SubAdmins.newPassword": "Nueva contraseña",
  "views.admin.SubAdmins.pleaseInputPassword": "Por favor ingrese la contraseña",
  "views.admin.SubAdmins.enable": "Habilitar",
  "views.admin.SubAdmins.disable": "Deshabilitar",
  "views.admin.SubAdmins.enabledOn": "Habilitado",
  "views.admin.SubAdmins.enabledOff": "Deshabilitado",
  "views.admin.SubAdmins.delete": "Eliminar",
  "views.admin.SubAdmins.deleteConfirm": "¿Eliminar subadministrador {username}?",
  "views.admin.SubAdmins.deleteConfirmTip": "Tras la eliminación, el subadministrador no podrá iniciar sesión. Los buzones creados se conservarán.",
  "views.admin.SubAdmins.quotaDelta": "Ajuste de cuota (positivo para sumar, negativo para restar)",
  "views.admin.SubAdmins.quotaDeltaTip": "Ingrese un número entero, ej. 100 o -50",
  "views.admin.SubAdmins.pleaseInput": "Por favor ingrese",
  "views.admin.SubAdmins.invalidQuota": "Valor de cuota inválido",
  "views.admin.SubAdmins.success": "Éxito",
  "views.admin.SubAdmins.save": "Guardar",
  "views.admin.DomainCreateCosts.tip": "Configure los puntos deducidos a subadministradores al crear buzones por dominio. 0 es gratuito.",
  "views.admin.DomainCreateCosts.save": "Guardar precios",
  "views.admin.DomainCreateCosts.success": "Guardado exitosamente",
  "views.admin.DomainCreateCosts.noDomains": "No hay dominios disponibles. Primero configure DOMAINS en la configuración del Worker.",
  "components.UsageGuide.title": "Guía de uso",
  "components.UsageGuide.adminStep1": "Cree buzones en la lista de cuentas y configure los días de validez.",
  "components.UsageGuide.adminStep2": "Envíe la dirección de correo y la contraseña al usuario.",
  "components.UsageGuide.adminStep3": "Los usuarios inician sesión mediante 'Inicio de sesión de buzón', pueden agregar múltiples buzones y ver extracción por IA / credenciales de agente en la configuración de cuenta.",
  "components.UsageGuide.personalStep1": "Inicie sesión con el correo y la contraseña proporcionados por el administrador.",
  "components.UsageGuide.personalStep2": "En el buzón puede recibir y (tras aprobación) enviar correos.",
  "components.UsageGuide.personalStep3": "Agregue más buzones o genere tokens de API para automatización en la configuración de cuenta.",
  "views.index.SimpleIndex.copyFailed": "Error al copiar",
  "views.index.SimpleIndex.queryFailed": "Error al cargar correos",
  "views.index.SimpleIndex.deleteFailed": "Error al eliminar correo",
}
