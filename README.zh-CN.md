[English](./README.md) · **中文** · [Español](./README.es.md) · [Português (Brasil)](./README.pt-BR.md) · [日本語](./README.ja.md) · [Deutsch](./README.de.md)
...
[项目亮点](#项目亮点) · [开号权就是产品](#开号权就是产品) · [快速开始](#快速开始) · [为什么需要企业邮局](#为什么需要企业邮局) · [系统架构](#系统架构) · [English](README.md) · [Español](README.es.md) · [Português](README.pt-BR.md) · [日本語](README.ja.md) · [Deutsch](README.de.md)
...
![登录页：邮箱用户或管理员](docs/screenshots/i18n/login-zh.png)
