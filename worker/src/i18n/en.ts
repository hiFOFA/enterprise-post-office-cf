...
const messages: LocaleMessages = {
    ...
    AddressAlreadyRegisteredMsg: "This mailbox is already registered",
    AddressExpiredMsg: "This mailbox has expired",
    InsufficientQuotaMsg: "Insufficient quota",
    ForbiddenForSubAdminMsg: "Sub-admin is not allowed to perform this action",
    SubAdminDisabledMsg: "Sub-admin account is disabled",
    SubAdminNotFoundMsg: "Sub-admin not found",
    SubAdminUsernameExistsMsg: "Sub-admin username already exists",
    SubAdminUsernameReservedMsg: "This username is reserved for the main admin",
    SubAdminHasAddressesMsg: "This sub-admin still has mailboxes; transfer or delete them first",
    InvalidExpireDaysMsg: "Invalid expire days",
    InvalidQuotaDeltaMsg: "Invalid quota delta",
    TgNewAddressDisabledMsg: "Telegram mailbox creation is disabled. Please contact an admin.",
    ...
    AiAdvisorNotBoundMsg: "Cloudflare Workers AI is not bound, AI advisor is unavailable",
    AiAdvisorNoMailboxMsg: "Authorize at least one mailbox first",
    AiAdvisorMessageRequiredMsg: "Please enter a question",
    AiAdvisorTooManyMailboxMsg: "You can authorize at most 80 mailboxes",
    AiAdvisorFailedMsg: "AI advisor is unavailable right now, please try again later",
    AiAdvisorCfDisabledMsg: "Ask an administrator to enable Cloudflare Workers AI",
    AiAdvisorNeedCustomMsg: "Save and test a custom API first",
    AiAdvisorInvalidProviderMsg: "Unsupported model provider",
    AiAdvisorInvalidUrlMsg: "Custom API URL is invalid; only public HTTPS is allowed",
    AiAdvisorNeedApiKeyMsg: "API key is required",
    AiAdvisorNeedModelIdMsg: "Model id is required",
    MissingTokenMsg: "Missing token",
    ApiTokenNotFoundMsg: "API token not found or already revoked",
    ApiTokenInvalidMsg: "API token is invalid or revoked",
    ApiTokenForbiddenMsg: "This token is not allowed to call this API",
    GroupNotFoundMsg: "Group not found",
    InvalidGroupIdMsg: "Invalid group id",
    InvalidGroupNameMsg: "Invalid group name",
    GroupLimitReachedMsg: "Group limit reached",
    DefaultOwnerGroupDeleteMsg: "Default groups cannot be deleted",
}
