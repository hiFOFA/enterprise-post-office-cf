export type LocaleMessages = {
    ...
    AddressAlreadyRegisteredMsg: string
    AddressExpiredMsg: string
    InsufficientQuotaMsg: string
    ForbiddenForSubAdminMsg: string
    SubAdminDisabledMsg: string
    SubAdminNotFoundMsg: string
    SubAdminUsernameExistsMsg: string
    SubAdminUsernameReservedMsg: string
    SubAdminHasAddressesMsg: string
    InvalidExpireDaysMsg: string
    InvalidQuotaDeltaMsg: string
    TgNewAddressDisabledMsg: string
    ...
    AiAdvisorNotBoundMsg: string
    AiAdvisorNoMailboxMsg: string
    AiAdvisorMessageRequiredMsg: string
    AiAdvisorTooManyMailboxMsg: string
    AiAdvisorFailedMsg: string
    AiAdvisorCfDisabledMsg: string
    AiAdvisorNeedCustomMsg: string
    AiAdvisorInvalidProviderMsg: string
    AiAdvisorInvalidUrlMsg: string
    AiAdvisorNeedApiKeyMsg: string
    AiAdvisorNeedModelIdMsg: string
    MissingTokenMsg: string
    ApiTokenNotFoundMsg: string
    ApiTokenInvalidMsg: string
    ApiTokenForbiddenMsg: string
    GroupNotFoundMsg: string
    InvalidGroupIdMsg: string
    InvalidGroupNameMsg: string
    GroupLimitReachedMsg: string
    DefaultOwnerGroupDeleteMsg: string
}
