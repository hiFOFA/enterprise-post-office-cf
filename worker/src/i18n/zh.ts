...
const messages: LocaleMessages = {
    ...
    AddressAlreadyRegisteredMsg: "此邮箱已被注册",
    AddressExpiredMsg: "此邮箱已过期",
    InsufficientQuotaMsg: "积分不足",
    ForbiddenForSubAdminMsg: "子管理无权执行此操作",
    SubAdminDisabledMsg: "子管理账号已禁用",
    SubAdminNotFoundMsg: "子管理不存在",
    SubAdminUsernameExistsMsg: "子管理用户名已存在",
    SubAdminUsernameReservedMsg: "该用户名已被主管理占用",
    SubAdminHasAddressesMsg: "该子管理仍有邮箱，请先转移或删除后再删除账号",
    InvalidExpireDaysMsg: "无效的到期天数",
    InvalidQuotaDeltaMsg: "无效的积分变动",
    TgNewAddressDisabledMsg: "Telegram 开箱已关闭，请联系管理员开通邮箱",
    ...
    AiAdvisorNotBoundMsg: "未绑定 Cloudflare Workers AI，无法使用 AI 顾问",
    AiAdvisorNoMailboxMsg: "请先授权至少一个邮箱",
    AiAdvisorMessageRequiredMsg: "请输入要询问的内容",
    AiAdvisorTooManyMailboxMsg: "一次最多授权 80 个邮箱",
    AiAdvisorFailedMsg: "AI 顾问暂时无法回答，请稍后再试",
    AiAdvisorCfDisabledMsg: "请联系管理员开放 Cloudflare Workers AI",
    AiAdvisorNeedCustomMsg: "请先配置并测试自定义 API",
    AiAdvisorInvalidProviderMsg: "不支持的模型驱动",
    AiAdvisorInvalidUrlMsg: "自定义 API 地址无效，仅允许公网 HTTPS",
    AiAdvisorNeedApiKeyMsg: "请填写 API Key",
    AiAdvisorNeedModelIdMsg: "请填写请求模型 ID",
    MissingTokenMsg: "缺少令牌参数",
    ApiTokenNotFoundMsg: "令牌不存在或已撤销",
    ApiTokenInvalidMsg: "API 令牌无效或已撤销",
    ApiTokenForbiddenMsg: "此令牌没有该接口的权限",
    GroupNotFoundMsg: "分组不存在",
    InvalidGroupIdMsg: "分组无效",
    InvalidGroupNameMsg: "分组名无效",
    GroupLimitReachedMsg: "已达到分组数量上限",
    DefaultOwnerGroupDeleteMsg: "默认分组不能删除",
}
