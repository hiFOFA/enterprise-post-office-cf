export const CONSTANTS = {
    ...
    DB_VERSION: "v0.0.13",
    ADMIN_JWT_TTL_SECONDS: 12 * 60 * 60,
    SUB_ADMIN_MAX_EXPIRE_DAYS: 90,
    DEFAULT_DOMAIN_CREATE_COST: 1,
    ...
    AI_ADVISOR_POLICY_KEY: 'ai_advisor_policy',
    DOMAIN_CREATE_COSTS_KEY: 'domain_create_costs',
    DEFAULT_ADDRESS_EXPIRE_DAYS_KEY: 'default_address_expire_days',
    GLOBAL_UI_PREFS_KEY: 'global_ui_prefs',
    GROUP_LIMITS_KEY: 'group_limits',
    DEFAULT_OWNER_GROUPS_KEY: 'default_owner_groups',
